...
public class Ciphers {
	...
	final static private  String PADDING = "PKCS5Padding";
	   ...
	   final static private  IvParameterSpec CBC_SALT = new IvParameterSpec(
	            new byte[] { 7, 34, 56, 78, 90, 87, 65, 43,
	                    12, 34, 56, 78, -123, 87, 65, 43 } );
	    final static private  byte[] BYTE_KEY = {4, -91, -30, -45, 28, -98, -80, -17, 100, 30, 28, -26, 94, 80, 69, 56, 111, 73, -44, -89, 72, -98, -105, 97, -27, 0, -19, 124, 73, 49, 120, 17};
	    ...
	    public final void writeCiphered(final File file,final String plainText )
	    ...
	    public final String readCiphered(final File file )
	            throws InvalidKeyException, IOException, InvalidAlgorithmParameterException
	        {
