...
import usagestatisticsclient.CommitingDetailsEmpty;
...
import usagestatisticsclient.PairLogInformationAndPassword;
import usagestatisticsclient.UsageLogger;
import usagestatisticsclient.UsageLoggerEmpty;
import usagestatisticsclient.UsageStatistic;
import usagestatisticsclient.UsageStatisticException;
...
public class UsageStatisticTest {
	...
	public void AT22_Server_doesnt_receive_data() throws Throwable
	{
		...
		Assert.assertEquals(inter.msg,UsageStatisticException.ERROR_WITH_CONNECTION_TO_SERVER);
		
		PrivateAccessor.setField(instance, "serverURL", new URI("http://fakeaddress.pl"));
		TestUtils.CommitAndWait(instance.createCommitRunnable(inter));
		Assert.assertTrue(inter.msg.equals(UsageStatisticException.SERVER_DOESNT_RECEIVE_DATA)||inter.msg.equals(UsageStatisticException.ERROR_WITH_CONNECTION_TO_SERVER)||inter.msg.equals(UsageStatisticException.CANNOT_EXTRACT_RESPONSE));
	...
	public void AT24_Connection_Lost() throws Throwable
	{
		...
		t.start();
		TestUtils.CommitAndWait(instance.createCommitRunnable(inter));
		Assert.assertTrue(UsageStatisticException.ERROR_WITH_CONNECTION_TO_SERVER.equals(inter.msg)||UsageStatisticException.SERVER_DOESNT_RECEIVE_DATA.equals(inter.msg));
	...
	public void AT25_Invalid_readout_log() throws Throwable
	{
		...
		Assert.assertEquals(com.msg, UsageStatisticException.LOG_WAS_NULL);
	...
	public void AT28_Cannot_delete_log_from_local_database() throws Throwable
	{
		...
		TestUtils.CommitAndWait(instance.createCommitRunnable(inter));
		Assert.assertEquals(inter.msg,UsageStatisticException.ERROR_WITH_CONNECTION_TO_LOCAL_DATABASE);
	}
